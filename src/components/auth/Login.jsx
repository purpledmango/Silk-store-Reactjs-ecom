...
const Login = ({ triggerLogin, setTriggerLogin, credentials }) => {
  ...
  return (
    <div className="relative w-full bg-gray-500 h-full ">
      <div className="shadow-3xl inset-0 absolute h-80 w-full md:w-1/2 mx-auto -translate-y-1/3  z-50 bg-bg-accent">
        <div className="p-10 w-full  bg-bg-accent flex flex-col items-center justify-center  border-[2px] border-gray-400 ">
          <div className="w-full flex justify-end text-2xl p-4">
